/*------------------------------------------------------------
   GuiNoRc.cpp -- Displays "Hello, Windows 98!" in client area
				 (c) Charles Petzold, 1998
				 
   GuiNoRc.cpp -- A bit modification for easier debugging.
				-- by Jimm Chen
   Compile it with command line in Visual C++ 2010+:
   
cl GuiNoRc.cpp /Od /MT /Zi /D_DEBUG /D_UNICODE /DUNICODE /link /debug kernel32.lib user32.lib gdi32.lib 
					...
					PTSTR szCmdLine, int iCmdShow)
{
	...
	static TCHAR szAppName[] = TEXT ("GuiNoRc") ;
	HWND         hwnd ;
	MSG          msg ;
	WNDCLASS     wndclass ;
	...
	hwnd = CreateWindow (szAppName,    // window class name
		TEXT ("The GuiNoRc Program"), // window caption
