	...
	PSTR szCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindow (szAppName, TEXT ("System Palette #3"), 
		...
		260, 300, // CW_USEDEFAULT, CW_USEDEFAULT,
...
LRESULT CALLBACK WndProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		// KEY: Create a DDB with predefined bit-array values.
	...
	case WM_PAINT:
		...
		// KEY: StretchBlt/BitBlt transfer DDB bit-array's value to video-RAM
		// with no color-lookup/color-transformation.
