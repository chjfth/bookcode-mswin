/*----------------------------------------
   SineWave.C -- MCI Command String Tester
...
INT_PTR CALLBACK DlgProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDC_ONOFF:
			...
			if (hWaveOut == NULL)
			{
				...
				pBuffer1  = (BYTE*) malloc (OUT_BUFFER_SIZE) ;
				pBuffer2  = (BYTE*) malloc (OUT_BUFFER_SIZE) ;
	...
	case MM_WOM_DONE:
		...
		assert((UINT_PTR)hWaveOut==(UINT_PTR)wParam);

		FillBuffer ( (BYTE*)(((PWAVEHDR)lParam)->lpData), iFreq ) ;
