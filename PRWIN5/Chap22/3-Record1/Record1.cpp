/*----------------------------------------
   Record1.C -- MCI Command String Tester
...
INT_PTR CALLBACK DlgProc (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case MM_WIM_DATA:
		...
		pNewBuffer = (BYTE*) realloc (pSaveBuffer, 
