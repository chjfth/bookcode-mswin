//-----------------------------------------------------------------------------
// Desc: Example code showing how to write simple pixel shader in D3D.
//-----------------------------------------------------------------------------
#define STRICT
#include <Windows.h>
#include <commctrl.h>
...
HRESULT CMyD3DApplication::Render()
{
    ...
    if( SUCCEEDED( m_pd3dDevice->BeginScene() ) )
    {
        if(m_pAsm_VS && m_pAsm_PS)
        {
            ...
            // Fixed function multitexture blender set up that
            // is no longer needed
...
//              D3DTOP_MODULATE );
//          m_pd3dDevice->SetTextureStageState( 1, D3DTSS_ALPHAARG1, 
//              D3DTA_TEXTURE );
//          m_pd3dDevice->SetTextureStageState( 1, D3DTSS_ALPHAARG2, 
//              D3DTA_TEXTURE );


//          m_pd3dDevice->SetTextureStageState( 2, D3DTSS_COLOROP, 
//              D3DTOP_DISABLE );
//          m_pd3dDevice->SetTextureStageState( 2, D3DTSS_ALPHAOP, 
//              D3DTOP_DISABLE );
...
HRESULT CMyD3DApplication::RestoreDeviceObjects()
{
    ...
    hr = DXUtil_FindMediaFileCb(szTexturePath, sizeof(szTexturePath), 
        _T("earth.bmp"));
    if( FAILED(hr) )
...
"mov oT0, v1   // output xzw texture coordinates\n"
