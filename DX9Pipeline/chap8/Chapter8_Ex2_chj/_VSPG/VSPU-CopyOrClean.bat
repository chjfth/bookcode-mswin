...
REM ////////////////////////////// Team Purpose //////////////////////////////
REM After EXE generated, copy ..\..\BookCommon\Media\bigship1.x|lobbycube.dds, 
REM and HLSL_MetallicFlakes.fx 
...
REM ==== Extra work ====
if not exist "%ProjectDir%\bigship1.x" (
	call :Echos We need bigship1.x alongside .vcxproj for direct F5/Ctrl+F5 local debug/run.
