//-----------------------------------------------------------------------------
// File: VertexShader_chj.cpp
//
// Desc: Example code showing how to do vertex shaders in D3D.
//
// [2025-11-17] Chj: I add quite some debug message(via vaDbgTs) to this code.
//-----------------------------------------------------------------------------
...
HRESULT CMyD3DApplication::FrameMove()
{
	...
	m_pd3dDevice->SetTransform( D3DTS_VIEW, &m_matView ); // chj: this line seems optional
...
"";
	...
	Cec_Release cec_gpucode = pGpuBytes;
	...
	// Chj: Peek into what those GPU bytes looks like.
