...
REM ////////////////////////////// Team Purpose //////////////////////////////
REM After EXE generated, copy 
REM		donot.bmp 
REM to EXE output dir, because the cpp code wants to load those file(s) at runtime.
...
set AGILE_COPY_PATTERNS="%ProjectDir%\donut.bmp"
