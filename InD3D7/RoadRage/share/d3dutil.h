...
HRESULT _DbgOut( TCHAR*, DWORD, HRESULT, TCHAR* );
    ...
    #define DEBUG_MSG(str)    _DbgOut( _T(__FILE__), (DWORD)__LINE__, 0, str )
    #define DEBUG_ERR(hr,str) _DbgOut( _T(__FILE__), (DWORD)__LINE__, hr, str )
#else
