...
inline BOOL 
CJob::SetSecurityLimitInfo(PJOBOBJECT_SECURITY_LIMIT_INFORMATION pjosli) 
{
	return(
		SetInformationJobObject(m_hJob, 
...
inline BOOL 
CJob::QueryAssociatedCompletionPort(PJOBOBJECT_ASSOCIATE_COMPLETION_PORT pjoacp) 
{
...
inline BOOL 
CJob::QueryBasicAccountingInfo(PJOBOBJECT_BASIC_AND_IO_ACCOUNTING_INFORMATION pjobai) 
{
	return(QueryInformationJobObject(m_hJob, 
...
inline BOOL 
CJob::QueryExtendedLimitInfo(PJOBOBJECT_EXTENDED_LIMIT_INFORMATION pjoeli) 
{
...
inline BOOL 
CJob::QueryBasicProcessIdList(DWORD dwMaxProcesses, 
...
inline BOOL 
CJob::QueryEndOfJobTimeInfo(PDWORD pfdwEndOfJobTimeInfo) 
{
...
inline BOOL 
CJob::QuerySecurityLimitInfo(PJOBOBJECT_SECURITY_LIMIT_INFORMATION pjosli) 
{
