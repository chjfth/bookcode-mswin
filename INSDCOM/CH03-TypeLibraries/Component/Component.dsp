...
!MESSAGE 
!MESSAGE "Component - Win32 Release" (based on\
 "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Component - Win32 Debug" (based on\
 "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
SOURCE=$(InputPath)
PostBuild_Desc=Registering the component
PostBuild_Cmds=regsvr32 /s debug\component.dll
# End Special Build Tool
...
"component.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"component_p.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"component_i.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"component.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
