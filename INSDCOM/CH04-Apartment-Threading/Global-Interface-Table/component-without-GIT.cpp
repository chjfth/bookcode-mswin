...
#include "Component-without-GIT\component.h" // Generated by MIDL
...
CInsideDCOM::CInsideDCOM() : m_cRef(1)
{
	...
	CoCreateInstance(CLSID_InsideDCOM2, NULL, CLSCTX_INPROC_SERVER, IID_ISum, (void**)&pSum);
}
