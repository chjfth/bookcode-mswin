...
public:
	...
	void operator =(LSA_UNICODE_STRING &lsastr) { AssignLSAStr(&lsastr); }
	void operator =(PLSA_UNICODE_STRING plsastr) { AssignLSAStr(plsastr); }
	void operator =(PWSTR pstr) { AssignString(pstr); }
